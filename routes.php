...
$router->post('/auth', 'controllers/registration/auth.php');
...
$router->post('/publicaciones', 'controllers/posts/publicaciones.php')->only('auth');   // DELETE via _method
$router->get('/crear-publicacion', 'controllers/posts/crear-publicacion.php')->only('auth');
$router->post('/crear-publicacion', 'controllers/posts/crear-publicacion.php')->only('auth');
